...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[620px] lg:min-h-[85vh] xl:min-h-[90vh] w-full overflow-hidden bg-[#fffdf7] pt-24 sm:pt-24 lg:pt-24 text-[#1f190f] flex flex-col justify-between">
