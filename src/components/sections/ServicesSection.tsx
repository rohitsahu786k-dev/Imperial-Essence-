    ...
    <section className={`${compact ? "py-16" : "py-24"} bg-white text-[#071321] relative overflow-hidden`}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`text-center max-w-3xl mx-auto ${compact ? "mb-12" : "mb-20"} space-y-4`}>
          <div className="inline-flex items-center gap-2 rounded-full bg-amber-50 border border-amber-200/80 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-[#B8860B]">
          ...
          <p className="text-base sm:text-lg text-slate-600">
            {t(
              "End-to-end B2B solutions bridging international brand owners, duty-free operators, and global distributors.",
              "Soluciones B2B integrales que conectan a marcas internacionales, operadores de duty-free y distribuidores globales."
            )}
          </p>
        </div>
          ...
          {siteData.services.map((svc, index) => (
            ...
            >
              ...
              <div className="relative w-full h-72 sm:h-80 overflow-hidden bg-slate-100">
                ...
                {/* Top Badge */}
                <span className="absolute top-4 left-4 rounded-full bg-white/95 backdrop-blur-md px-4 py-1.5 text-xs font-extrabold text-[#071321] uppercase tracking-wider shadow-sm border border-slate-200">
                  Service 0{index + 1}
                </span>
              </div>
              ...
              <div className="p-8 space-y-5 flex-1 flex flex-col justify-between">
                <div className="space-y-3">
                  <h3 className="text-2xl font-extrabold text-[#071321] group-hover:text-[#B8860B] transition">
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                  <span className="text-xs font-semibold text-slate-400">Dubai HQ, UAE</span>
                  <Link
                    href="/contact"
                    className="inline-flex items-center gap-2 rounded-full bg-gold-gradient px-5 py-2.5 text-xs font-extrabold uppercase tracking-wider text-slate-950 transition hover:opacity-95 shadow-md"
                  >
